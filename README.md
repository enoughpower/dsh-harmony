...
> 本工程当前 compatibleSdkVersion / targetSdkVersion 为 `6.0.0(20)`，待确认 7.0 对应 API 版本后升级。
...
```
├── AppScope/              应用级配置（bundleName: com.dsh.harmony）
├── entry/                 主模块
│   └── src/main/ets/
